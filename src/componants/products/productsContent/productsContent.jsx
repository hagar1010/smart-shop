            ...
            <div className="products-control-header">
                <div>
                    <select>
                        ...
                        <option>الاكثر شعبية</option>
                        <option>على حسب التقييم</option>
                        ...
                        <div className="main-products">
                            {
                                slide.data.map((product, index) => {
                                    if (product.size == chossed.chossed) {
                                        return <SinglProduct key={index} product={product} />
                                    } else if (chossed.chossed == '')
                                        return <SinglProduct key={index} product={product} />
                                })
                            }
                        </div>
